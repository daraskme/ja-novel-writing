...
|---|---|---|---|---|---|---|
| romance-rooftop-mutual（492301c4fab0） | 1 | prev / new → new | new / prev → new | **new** | 1086 / 1091 | 範囲内 / 範囲内 |
| romance-festival-childhood-friend（d9379a240ab8） | 1 | prev / new → prev | new / prev → prev | **prev** | 1267 / 1310 | 指定なし / 指定なし |
| romance-restrained-reunion（350120861171） | 1 | prev / new → prev | new / prev → new | **順序不安定** | 943 / 1033 | 指定なし / 指定なし |
| romance-unrequited-farewell（b91872a754ab） | 1 | new / prev → new | prev / new → prev | **順序不安定** | 1201 / 1237 | 指定なし / 指定なし |
| office-kitchenette-comedy（f6a3f2c02f27） | 1 | new / prev → prev | prev / new → new | **順序不安定** | 947 / 838 | 範囲内 / 範囲内 |
...
- romance-restrained-reunion: 順序不安定 1
