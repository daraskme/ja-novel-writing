...
|---|---|---|---|---|---|---|
| graduation-confession（afba44ea0cb1） | 1 | new / prev → new | prev / new → prev | **順序不安定** | 1271 / 1398 | 範囲内 / 範囲内 |
| graduation-confession（afba44ea0cb1） | 2 | prev / new → prev | new / prev → new | **順序不安定** | 1321 / 1263 | 範囲内 / 範囲内 |
...
| graduation-confession | 1 | prev | 0 | 0 | 2 / 1（M02 R03） | 3 / 9（C07 K00 R01） |
| graduation-confession | 2 | new | 0 | 0 | 1 / 1（M02） | 3 / 4（C07 D03 K00） |
| graduation-confession | 2 | prev | 0 | 0 | 1 / 1（M02） | 3 / 5（C07 K00 O02） |
