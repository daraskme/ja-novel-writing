...
|---|---|---|---|---|---|---|
| graduation-confession（afba44ea0cb1） | 1 | with / base → base | base / with → base | **base** | 1353 / 1285 | 範囲内 / 範囲内 |
| graduation-confession（afba44ea0cb1） | 2 | base / with → base | with / base → base | **base** | 1378 / 1418 | 範囲内 / 範囲内 |

## 依頼ごとの内訳

試行数が依頼ごとに違うので、合計の勝敗や勝率は出さない。過去のラウンドの結果とも合算しない。

- graduation-confession: base 2
