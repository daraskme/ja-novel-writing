...
|---|---|---|---|---|---|---|
| graduation-confession（afba44ea0cb1） | 1 | base / with → base | with / base → base | **base** | 1376 / 1518 | 範囲内 / 超過 |
| graduation-confession（afba44ea0cb1） | 2 | with / base → with | base / with → base | **順序不安定** | 1339 / 1515 | 範囲内 / 超過 |

## 依頼ごとの内訳

試行数が依頼ごとに違うので、合計の勝敗や勝率は出さない。過去のラウンドの結果とも合算しない。

- graduation-confession: base 1、順序不安定 1
