...
| web-episode-twelve-reminder（af41771f1f46） | 2 | with / base → base | base / with → base | **base** | 2845 / 967 | 指定なし / 指定なし |
| library-bookmark-mystery（eb64d29b6626） | 1 | base / with → with | with / base → with | **with** | 1628 / 1186 | 指定なし / 指定なし |
| library-bookmark-mystery（eb64d29b6626） | 2 | base / with → with | with / base → with | **with** | 1447 / 1369 | 指定なし / 指定なし |

## 依頼ごとの内訳

試行数が依頼ごとに違うので、合計の勝敗や勝率は出さない。過去のラウンドの結果とも合算しない。

- web-episode-twelve-reminder: base 2
- library-bookmark-mystery: with 2
