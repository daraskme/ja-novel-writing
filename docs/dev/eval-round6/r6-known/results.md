...
|---|---|---|---|---|---|---|
| graduation-confession（afba44ea0cb1） | 1 | with / base → with | base / with → with | **with** | 1270 / 1192 | 範囲内 / 不足 |
| romance-direct-confession（c0b6c036f4d2） | 1 | with / base → base | base / with → base | **base** | 587 / 523 | 指定なし / 指定なし |
