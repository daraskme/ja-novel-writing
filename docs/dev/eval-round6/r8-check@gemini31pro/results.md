...
|---|---|---|---|---|---|---|
| web-episode-twelve-reminder（af41771f1f46） | 1 | with / base → base | base / with → base | **base** | 2885 / 1073 | 指定なし / 指定なし |
...
| library-bookmark-mystery（eb64d29b6626） | 2 | base / with → 差なし | with / base → with | **順序不安定** | 1447 / 1369 | 指定なし / 指定なし |

## 依頼ごとの内訳

試行数が依頼ごとに違うので、合計の勝敗や勝率は出さない。過去のラウンドの結果とも合算しない。

- web-episode-twelve-reminder: base 1、with 1
- library-bookmark-mystery: 順序不安定 2
