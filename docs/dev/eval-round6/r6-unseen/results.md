...
| library-bookmark-mystery（eb64d29b6626） | 1 | with / base → with | base / with → with | **with** | 1421 / 1137 | 指定なし / 指定なし |
| sf-last-report（a4b4c18b9e7b） | 1 | base / with → with | with / base → with | **with** | 1176 / 1237 | 指定なし / 指定なし |
| jidai-pawned-sword（623101c52656） | 1 | with / base → with | base / with → with | **with** | 1239 / 1270 | 指定なし / 指定なし |
| bungei-unknown-key（4ab4568eff43） | 1 | with / base → with | base / with → with | **with** | 1348 / 1381 | 指定なし / 指定なし |
...
- library-bookmark-mystery: with 1
- sf-last-report: with 1
- jidai-pawned-sword: with 1
- bungei-unknown-key: with 1
